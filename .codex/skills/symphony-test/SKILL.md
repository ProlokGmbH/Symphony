...
4. Wenn während der Schleife lokale Fixes entstanden sind, committe sie bei Bedarf in diesem Status mit `<Issue-Key> Test (AI) Autocommit` plus kurzem Body, bevor der nächste Pull- oder Merge-Schritt sie aufnimmt.
