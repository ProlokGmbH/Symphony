...
- Lies die repository-spezifischen Anweisungen aus `.symphony/review_codex.md`.
...
- Öffne zu Beginn `.symphony/review_codex.md` im Repository-Root und lies die Datei vollständig.
- Verwende die Datei als maßgebliche Quelle für die konkrete Review-Checkliste und ihre Reihenfolge.
- Erfinde keine fehlenden Review-Schritte aus früheren Repository-Konventionen.
- Wenn `.symphony/review_codex.md` fehlt oder nicht lesbar ist, dokumentiere das im Workpad und stoppe statt eine Checkliste zu raten.

## Workpad-Aktualisierung

- Nutze den vorhandenen Kommentar `## Codex Workpad`.
- Spiegele die Schritte aus `.symphony/review_codex.md` unter `### Review` als Checkliste in derselben Reihenfolge.
...
1. Lies `.symphony/review_codex.md` und beginne mit dem ersten dort definierten Schritt.
